...
SpriteMorph.prototype.blockAlternatives = {
    ...
    reportQuotient: ['reportDifference', 'reportProduct', 'reportSum','reportFloorDiv'],
    reportFloorDiv: ['reportSum','reportDifference','reportProduct','reportQuotient'],
...
SpriteMorph.prototype.blockTemplates = function (category) {
    ...
    */
    ...
    // for debugging: ///////////////
        ...
        blocks.push(block('reportFloorDiv'));
        blocks.push('-');
