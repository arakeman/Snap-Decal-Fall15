...
SnapSerializer.prototype.add = function (xmlString, ide) {
    // public - answer a new Project represented by the given XML String
    return this.addProjectModel(this.parse(xmlString), ide);
};
...
SnapSerializer.prototype.addProjectModel = function (xmlNode, ide) {
    // public - answer a new Project represented by the given XML top node
    // show a warning if the origin apps differ
    ...
    return this.rawAddProjectModel(xmlNode);
};
...
SnapSerializer.prototype.rawAddProjectModel = function (xmlNode) {
    // private
    var myself = this,
